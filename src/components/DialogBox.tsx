            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md bg-timberwolf-300 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-timberwolf-200 sm:ml-3 sm:w-auto"
                    onClick={(e) => {
                      addWish(e)
                      setOpen(false)
                    }}
...
const Form = () => {
  ...
  return (
    <div className="space-y-4 dialog-input">
      <label htmlFor="name">
        <input
          type="text"
          id="name"
